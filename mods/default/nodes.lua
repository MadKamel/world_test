...
minetest.register_node("default:tree", {
	...
	paramtype2 = "facedir",
	is_ground_content = false,
	groups = {tree = 1, choppy = 2, oddly_breakable_by_hand = 1, falling_node = 1, flammable = 2},
...
minetest.register_node("default:apple", {
	...
	groups = {fleshy = 3, dig_immediate = 3, falling_node = 1, flammable = 2,
...
minetest.register_node("default:pine_tree", {
	...
	paramtype2 = "facedir",
	is_ground_content = false,
	groups = {tree = 1, choppy = 3, oddly_breakable_by_hand = 1, falling_node = 1, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
